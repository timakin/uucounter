...
After installation, Generate uu_counter libs in your project.
...
UUCounter API provides 2 main methods to check and set access track.

```
UUCounter#get_count(path): Returns UU count to the path
UUCounter#track(): Track pageview with uu token and path information
```
...
class TestController < ActionController::Base
    ...
    def foo
        @pageview_count = UUCounter.get_count("/test/path")
    end
    ...
end
```
